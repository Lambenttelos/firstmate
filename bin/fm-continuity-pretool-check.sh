...
# command other than bin/fm-wake-drain.sh, bin/fm-wake-brief.sh, bin/fm-watch-arm.sh,
# or the independently fail-closed bin/fm-teardown.sh, and only when the active primary
